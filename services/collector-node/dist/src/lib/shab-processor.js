...
exports.shabProcessorService = exports.ShabProcessorService = void 0;
const shared_ts_1 = require("@auctiondeal/shared-ts");
const shab_api_1 = require("./shab-api");
const shab_1 = require("../types/shab");
class ShabProcessorService {
    constructor() {
        this.shabApi = new shab_api_1.ShabApiService();
        const client = (0, shared_ts_1.getPrismaClient)();
        if (!client) {
    ...
    async processDailyPublications() {
        ...
        try {
            ...
            throw new shab_1.ShabProcessingError(`Daily processing failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
    ...
    async processHistoricalPublications(daysBack = 90) {
        ...
        try {
            ...
            throw new shab_1.ShabProcessingError(`Historical processing failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
    }
    /**
...
exports.ShabProcessorService = ShabProcessorService;
// Singleton instance for direct usage
exports.shabProcessorService = new ShabProcessorService();
